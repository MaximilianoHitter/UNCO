...
<body>
    <div class="col-mb-12 contenedor">
        <form class="" action="../Controlador/mostrarpelicula.php" method="POST" onsubmit="return validar();" novalidate enctype="multipart/form-data">
            ...
            <div class="contenido">
                    ...
                    <div class="col-md-4 p2">
                        ...
                        <section>
                            ...
                            <div class="form-check check2">
                                <input class="form-check-input" type="radio" name="publico" value="mayosres de 7 años" id="publico">
                                <label class="form-check-label" for="publico">
                                    Mayores de 7 años
                                </label>
                            </div>
                ...
                <fieldset>
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Seleccione una imagen para subir</label>
                        <input class="form-control input" type="file" id="archivo" name="archivo">
            ...
            <script>
                ...
                function validarArchivo(){
                    if(archivo.value != ''){
                        archivo.classList.add('gut');
                        archivo.classList.remove('bad');
                        return true;
                    }else{
                        archivo.classList.add('bad');
                        archivo.classList.remove('gut');
                        return false;
                    }
                }
                ...
                function validarAnio() {
                    ...
                    if ((anioContenido.length < 4 || anioContenido.lengt > 4 ) || anioContenido > anioActual) {
                        anio.classList.remove('gut');
                        anio.classList.add('bad');
                        anioV.style.display = 'block';
                        anioV.innerHTML = 'El año debe poseer 4 numeros y ser menor o igual al actual';
                        validaciones[0] = 'false';
                        return (false);
                    } else {
                ...
                function validar() {
                    ...
                    validarDuracion();
                    validarArchivo()
                    if (validarArchivo() && validarTitulo() && validarActores() && validarDirector() && validarGuion() && validarProduccion() && validarNacionalidad() && validarSinopsis() && validarAnio() && validarDuracion()) {
